...
module.exports = function (app) {
    ...
    var nameDisposeMiddleWare = require("../middleware/nameDispose");
    router
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    queryOptions = {};
                    return [4 /*yield*/, req.Model.find().setOptions(queryOptions).limit(10)];
                case 1:
                    items = _a.sent();
                    res.send(items);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.findById(req.params.id)];
                case 1:
                    model = _a.sent();
                    res.send(model);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.create(req.body)];
                case 1:
                    model = _a.sent();
                    res.send(model);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.findByIdAndUpdate(req.params.id, req.body)];
                case 1:
                    model = _a.sent();
                    res.send(model);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.Model.findByIdAndDelete(req.params.id, req.body)];
                case 1:
                    model = _a.sent();
                    res.send(model);
                    return [2 /*return*/];
